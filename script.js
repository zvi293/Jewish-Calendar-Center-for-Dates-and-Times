...
רִבּוֹנוֹ שֶׁל עוֹלָם, עִלַּת הָעִלּוֹת וְסִבַּת כָּל הַסִּבּוֹת, אַנְתְּ לְעֵלָּא, לְעֵלָּא מִן כֹּלָּא, וְלֵית לְעֵלָּא מִנָּךְ, דְלֵית מַחֲשָׁבָה תְּפִיסָא בָּךְ כְּלָל. וּלְךָ דּוּמִיָּה תְהִלָּה; וּמְרוֹמָם עַל כָּל בְּרָכָה וּתְהִלָּה. אוֹתְךָ אֶדְרֹשׁ, אוֹתְךָ אֲבַקֵּשׁ, שֶׁתַּחְתֹּר חֲתִירָה דֶּרֶךְ כְּבוּשָׁה מֵאִתְּךָ, דֶּרֶךְ כָּל הָעוֹלָמוֹת עַד הַהִשְׁתַּלְשְׁלוּת שֶׁלִּי, בַּמָּקוֹם שֶׁאֲנִי עוֹמֵד, כְּפִי אֲשֶׁר נִגְלֶה לְךָ, יוֹדֵעַ תַּעֲלוּמוֹת. וּבַדֶּרֶךְ וְנָתִיב הַזֶּה תָּאִיר עָלַי אוֹרְךָ, לְהַחֲזִירֵנִי בִּתְשׁוּבָה שְׁלֵמָה לְפָנֶיךָ בֶּאֱמֶת, כְּפִי רְצוֹנְךָ בֶּאֱמֶת; כְּפִי רְצוֹן מִבְחַר הַבְּרוּאִים: לִבְלִי לַחְשֹׁב בְּמַחֲשַׁבְתִּי שׁוּם מַחֲשֶּׁבֶת חוּץ וְשׁוּם מַחֲשָׁבָה וּבִלְבּוּל שֶׁהוּא נֶגֶד רְצוֹנֶךָ. רַק לְדַבֵּק בְּמַחֲשָׁבוֹת זַכּוֹת, צַחוֹת וּקְדוֹשׁוֹת בַּעֲבוֹדָתְך בֶּאֱמֶת, בְּהַשָּׂגָתְךָ וּבְתוֹרָתֶךָ. הַט לִבִּי אֶל עֵדְוֹתֶיך וְתַן לִי לֵב טָהוֹר לְעָבְדְּךָ בֶּאֱמֶת. וּמִמְּצוּלוֹת יָם תּוֹצִיאֵנִי לְאוֹר גָּדוֹל חִישׁ קַל מְהֵרָה, תְּשׁוּעַת אֲדֹנָי כְּהֶרֶף עַיִן, לֵאוֹר בְּאוֹר הַחַיִּים, כָּל יְמֵי הֱיוֹתִי עַל פְּנֵי הָאֲדָמָה; וְאֶזְכֶּה לְחַדֵּש נְעוּרָי, הַיָּמִים שֶׁעָבְרוּ בַּחֹשֶׁךְ לְהַחֲזִירָם אֶל הַקְּדֻשָּׁה. וְתִהְיֶה יְצִיאָתִי מִן הָעוֹלָם כְּבִיאָתִי: בְּלֹא חֵטְא. וְאֶזְכֶּה לַחֲזוֹת בְּנֹעַם אֲדֹנָי וּלְבַקֵּר בְּהֵיכָלוֹ, כֻּלּוֹ אוֹמֵר כָּבוֹד. אָמֵן נֶצַח סֶלָה וָעֶד.`;
      ...
      function buildBirkatHamazonPayload(context) {
        ...
        const needsYaaleh = context.isRoshChodesh || context.isPesach || context.isShavuot || context.isSukkot || context.isRoshHaShana;
        let yaalehDayInsert = '';
        if (context.isRoshChodesh) yaalehDayInsert = 'רֹאשׁ הַחֹֽדֶשׁ הַזֶּה';
        else if (context.isRoshHaShana) yaalehDayInsert = 'הַזִּכָּרוֹן הַזֶּה, בְּיוֹם טוֹב מִקְרָא קֹֽדֶשׁ הַזֶּה';
        else if (context.isPesach) yaalehDayInsert = 'חַג הַמַּצּוֹת הַזֶּה, בְּיוֹם טוֹב מִקְרָא קֹֽדֶשׁ הַזֶּה';
        else if (context.isShavuot) yaalehDayInsert = 'חַג הַשָּׁבֻעוֹת הַזֶּה, בְּיוֹם טוֹב מִקְרָא קֹֽדֶשׁ הַזֶּה';
        else if (context.isSukkot) yaalehDayInsert = 'חַג הַסֻּכּוֹת הַזֶּה, בְּיוֹם טוֹב מִקְרָא קֹֽדֶשׁ הַזֶּה';
        ...
        if (nusach === 'mizrahi') {
          ...
          parts.push(sup(
            ...
            p('הַמְסֻבִּים עוֹנִים: יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד־עוֹלָם:') +
            p('חוֹזֵר הַמְזַמֵּן: יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד־עוֹלָם:') +
            p('וּמְמַשִּׁיךְ: בִּרְשׁוּת מָרָנָן וְרַבָּנָן וְרַבּוֹתַי נְבָרֵךְ (בַּעֲשָׂרָה: אֱלֹהֵֽינוּ) שֶׁאָכַֽלְנוּ מִשֶּׁלּוֹ:') +
            (nusach === 'sfard'
              ? p('הַמְסֻבִּים עוֹנִים: בָּרוּךְ (בַּעֲשָׂרָה: אֱלֹהֵֽינוּ) שֶֽׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ: מִי שֶׁלֹּא אָכַל עוֹנֶה: בָּרוּךְ הוּא וּבָרוּךְ שְׁמוֹ:')
              : p('הַמְסֻבִּים עוֹנִים: בָּרוּךְ (בַּעֲשָׂרָה: אֱלֹהֵֽינוּ) שֶֽׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ: מִי שֶׁלֹּא אָכַל עוֹנֶה: בָּרוּךְ (בַּעֲשָׂרָה: אֱלֹהֵינוּ) וּמְבוֹרָךְ שְׁמוֹ תָּמִיד לְעוֹלָם וָעֶד:')) +
            p('חוֹזֵר הַמְזַמֵּן: בָּרוּךְ (בַּעֲשָׂרָה: אֱלֹהֵֽינוּ) שֶֽׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ:')
          ));
          ...
          if (nusach === 'sfard') {
            parts.push(sup(
              ...
              p('הַמְזַמֵּן אוֹמֵר: רַבּוֹתַי נְבָרֵךְ:') +
              p('הַמְסֻבִּים: יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד־עוֹלָם:') +
              p('וּמְמַשִּׁיךְ: דְּוַי הָסֵר וְגַם חָרוֹן, וְאָז אִלֵּם בְּשִׁיר יָרוֹן, נְחֵֽנוּ בְּמַעְגְּ֒לֵי צֶֽדֶק, שְׁעֵה בִּרְכַּת בְּנֵי אַהֲרֹן:') +
              p('בִּרְשׁוּת מָרָנָן וְרַבָּנָן וְרַבּוֹתַי נְבָרֵךְ אֱלֹהֵֽינוּ שֶׁהַשִּׁמְחָה בִּמְעוֹנוֹ וְשֶׁאָכַֽלְנוּ מִשֶּׁלּוֹ:') +
              p('הַמְסֻבִּים: בָּרוּךְ אֱלֹהֵֽינוּ שֶׁהַשִּׁמְחָה בִּמְעוֹנוֹ וְשֶׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ:') +
              p('חוֹזֵר הַמְזַמֵּן: בָּרוּךְ אֱלֹהֵֽינוּ שֶׁהַשִּׁמְחָה בִּמְעוֹנוֹ וְשֶׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ:')
            ));
          }
          ...
          // יעלה ויבוא — ראש חודש / יו"ט / חוה"מ
          if (needsYaaleh) {
            parts.push(p('אֱלֹהֵֽינוּ וֵאלֹהֵי אֲבוֹתֵֽינוּ יַעֲלֶה וְיָבֹא וְיַגִּֽיעַ וְיֵרָאֶה וְיֵרָצֶה וְיִשָּׁמַע וְיִפָּקֵד וְיִזָּכֵר זִכְרוֹנֵֽינוּ וּפִקְדוֹנֵֽינוּ וְזִכְרוֹן אֲבוֹתֵֽינוּ וְזִכְרוֹן מָשִֽׁיחַ בֶּן־דָּוִד עַבְדֶּֽךָ וְזִכְרוֹן יְרוּשָׁלַֽיִם עִיר קָדְשֶֽׁךָ וְזִכְרוֹן כָּל־עַמְּ֒ךָ בֵּית יִשְׂרָאֵל לְפָנֶֽיךָ, לִפְלֵיטָה לְטוֹבָה לְחֵן וּלְחֶֽסֶד וּלְרַחֲמִים וּלְחַיִּים טוֹבִים וּלְשָׁלוֹם בְּיוֹם ' + yaalehDayInsert + '. זָכְרֵֽינוּ יְהֹוָה אֱלֹהֵֽינוּ בּוֹ לְטוֹבָה, וּפָקְדֵֽינוּ בוֹ לִבְרָכָה, וְהוֹשִׁיעֵֽנוּ בוֹ לְחַיִּים טוֹבִים, וּבִדְבַר יְשׁוּעָה וְרַחֲמִים חוּס וְחָנֵּֽינוּ, וְרַחֵם עָלֵֽינוּ וְהוֹשִׁיעֵֽינוּ, כִּי אֵלֶֽיךָ עֵינֵֽינוּ, כִּי אֵל מֶֽלֶךְ חַנּוּן וְרַחוּם אָֽתָּה:'));
          }

          // וּבְנֵה — בּוֹנֵה יְרוּשָׁלַיִם
          parts.push(p('וּבְנֵה יְרוּשָׁלַֽיִם עִיר הַקֹּֽדֶשׁ בִּמְהֵרָה בְיָמֵֽינוּ: בָּרוּךְ אַתָּה יְהֹוָה בּוֹנֵה בְרַחֲמָיו יְרוּשָׁלָֽיִם, אָמֵן:'));

          // ברכה רביעית — הטוב והמטיב
          parts.push(hr);
          parts.push(p('<strong>בְּרָכָה רְבִיעִית — הַטּוֹב וְהַמֵּטִיב</strong>'));
          parts.push(p('בָּרוּךְ אַתָּה יְהֹוָה אֱלֹהֵֽינוּ מֶֽלֶךְ הָעוֹלָם, הָאֵל אָבִֽינוּ, מַלְכֵּֽנוּ, אַדִּירֵֽנוּ בּוֹרְ֒אֵֽנוּ, גּוֹאֲלֵֽנוּ, יוֹצְ֒רֵֽנוּ, קְדוֹשֵֽׁנוּ קְדוֹשׁ יַעֲקֹב, רוֹעֵנוּ רוֹעֵה יִשְׂרָאֵל, הַמֶּֽלֶךְ הַטּוֹב, וְהַמֵּטִיב לַכֹּל, שֶׁבְּ֒כָל יוֹם וָיוֹם הוּא הֵטִיב, הוּא מֵטִיב, הוּא יֵיטִיב לָנוּ, הוּא גְמָלָֽנוּ, הוּא גוֹמְ֒לֵֽנוּ, הוּא יִגְמְ֒לֵֽנוּ לָעַד לְחֵן וּלְחֶֽסֶד וּלְרַחֲמִים וּלְרֶוַח הַצָּלָה וְהַצְלָחָה בְּרָכָה וִישׁוּעָה, נֶחָמָה, פַּרְנָסָה וְכַלְכָּלָה, וְרַחֲמִים, וְחַיִּים וְשָׁלוֹם, וְכָל־טוֹב, וּמִכָּל־טוּב לְעוֹלָם אַל יְחַסְּ֒רֵֽנוּ:'));

          // הרחמן — standard list
          parts.push(p('הָרַחֲמָן הוּא יִמְלוֹךְ עָלֵֽינוּ לְעוֹלָם וָעֶד: הָרַחֲמָן הוּא יִתְבָּרֵךְ בַּשָּׁמַֽיִם וּבָאָֽרֶץ: הָרַחֲמָן הוּא יִשְׁתַּבַּח לְדוֹר דּוֹרִים, וְיִתְפָּאֵר בָּֽנוּ לָעַד וּלְנֵֽצַח נְצָחִים, וְיִתְהַדַּר בָּֽנוּ לָעַד וּלְעוֹלְ֒מֵי עוֹלָמִים: הָרַחֲמָן הוּא יְפַרְנְ֒סֵֽנוּ בְּכָבוֹד: הָרַחֲמָן הוּא יִשְׁבּוֹר עֻלֵּֽנוּ מֵעַל צַוָּארֵֽנוּ וְהוּא יוֹלִיכֵֽנוּ קוֹמְ֒מִיּוּת לְאַרְצֵֽנוּ: הָרַחֲמָן הוּא יִשְׁלַח לָֽנוּ בְּרָכָה מְרֻבָּה בַּבַּֽיִת הַזֶּה וְעַל־שֻׁלְחָן זֶה שֶׁאָכַֽלְנוּ עָלָיו: הָרַחֲמָן הוּא יִשְׁלַח לָֽנוּ אֶת־אֵלִיָּֽהוּ הַנָּבִיא זָכוּר לַטּוֹב, וִיבַשֶּׂר־לָֽנוּ בְּשׂוֹרוֹת טוֹבוֹת יְשׁוּעוֹת וְנֶחָמוֹת:'));

          // הרחמן — ברכת בעל הבית (supplement)
          parts.push(sup(
            p('[אִם סָמוּךְ עַל שֻׁלְחַן אָבִיו יֹאמַר:] הָרַחֲמָן הוּא יְבָרֵךְ אֶת (אָבִי מוֹרִי) בַּֽעַל הַבַּֽיִת הַזֶּה, וְאֶת (אִמִּי מוֹרָתִי) בַּעֲלַת הַבַּֽיִת הַזֶּה, אוֹתָם וְאֶת בֵּיתָם וְאֶת זַרְעָם וְאֶת כָּל אֲשֶׁר לָהֶם.') +
            p('[אִם סָמוּךְ עַל שֻׁלְחַן עַצְמוֹ יֹאמַר:] הָרַחֲמָן הוּא יְבָרֵךְ אוֹתִי (וְאֶת אִשְׁתִּי / בַּעֲלִי וְאֶת זַרְעִי) וְאֶת כָּל אֲשֶׁר לִי.') +
            p('אוֹתָֽנוּ וְאֶת כָּל אֲשֶׁר לָֽנוּ, כְּמוֹ שֶׁנִּתְבָּרְ֒כוּ אֲבוֹתֵֽינוּ, אַבְרָהָם יִצְחָק וְיַעֲקֹב: בַּכֹּל, מִכֹּל, כֹּל, כֵּן יְבָרֵךְ אוֹתָֽנוּ כֻּלָּֽנוּ יַֽחַד, בִּבְרָכָה שְׁלֵמָה, וְנֹאמַר אָמֵן:') +
            p('[אִם אוֹכֵל עַל שֻׁלְחַן אֲחֵרִים:] הָרַחֲמָן הוּא יְבָרֵךְ אֶת בַּֽעַל הַבַּֽיִת הַזֶּה, וְאֶת אִשְׁתּוֹ בַּעֲלַת הַבַּֽיִת הַזֶּה, אוֹתָם וְאֶת בֵּיתָם וְאֶת זַרְעָם וְאֶת כָּל אֲשֶׁר לָהֶם. יְהִי רָצוֹן שֶׁלֺּא יֵבוֹשׁ בַּֽעַל הַבַּֽיִת בָּעוֹלָם הַזֶּה וְלֺא יִכָּלֵם לָעוֹלָם הַבָּא וְיִצְלַח מְאֹד בְּכָל נְכָסָיו וְיִהְיוּ נְכָסָיו וּנְכָסֵֽינוּ מֻצְלָחִים וּקְרוֹבִים לָעִיר וְאַל יִשְׁלוֹט שָׂטָן לֺא בְמַעֲשֵׂי יָדָיו וְלֺא בְמַעֲשֵׂי יָדֵֽינוּ:') +
            p('[בִּסְעוּדַּת חָתָן וְכַלָּה:] דְּוַי הָסֵר וְגַם חָרוֹן, וְאָז אִלֵּם בְּשִׁיר יָרוֹן, נְחֵֽנוּ בְּמַעְגְּ֒לֵי צֶֽדֶק, שְׁעֵה בִּרְכַּת בְּנֵי אַהֲרֹן. הָרַחֲמָן הוּא יְבָרֵךְ אֶת הֶחָתָן וְהַכַּלָּה.')
          ));

          // בַּמָּרוֹם יְלַמְּדוּ
          parts.push(p('בַּמָּרוֹם יְלַמְּ֒דוּ עֲלֵיהֶם וְעָלֵֽינוּ זְכוּת שֶׁתְּ֒הֵא לְמִשְׁמֶֽרֶת שָׁלוֹם, וְנִשָּׂא בְרָכָה מֵאֵת יְהֹוָה וּצְדָקָה מֵאֱלֹהֵי יִשְׁעֵֽנוּ, וְנִמְצָא חֵן וְשֵֽׂכֶל טוֹב בְּעֵינֵי אֱלֹהִים וְאָדָם:'));

          // הרחמן — שבת
          if (context.isShabbat) {
            parts.push(p('הָרַחֲמָן הוּא יַנְחִילֵֽנוּ יוֹם שֶׁכֻּלּוֹ שַׁבָּת וּמְנוּחָה לְחַיֵּי הָעוֹלָמִים:'));
          }
          // הרחמן — ראש חודש
          if (context.isRoshChodesh) {
            parts.push(p('הָרַחֲמָן הוּא יְחַדֵּשׁ עָלֵֽינוּ אֶת הַחֹֽדֶשׁ הַזֶּה לְטוֹבָה וְלִבְרָכָה:'));
          ...
          // הרחמן — סוכות
          if (context.isSukkot) {
            parts.push(p('הָרַחֲמָן הוּא יָקִים לָֽנוּ אֶת סֻכַּת דָּוִד הַנּוֹפָֽלֶת:'));
          }

          // סיום
          parts.push(p('הָרַחֲמָן הוּא יְזַכֵּֽנוּ לִימוֹת הַמָּשִֽׁיחַ וּלְחַיֵּי הָעוֹלָם הַבָּא, מַגְדִּיל יְשׁוּעוֹת מַלְכּוֹ (בְּשַׁבָּת וּבְיוֹם טוֹב: מִגְדּוֹל יְשׁוּעוֹת מַלְכּוֹ), וְעֹֽשֶׂה חֶֽסֶד לִמְשִׁיחוֹ לְדָוִד וּלְזַרְעוֹ עַד עוֹלָם: עֹשֶׂה שָׁלוֹם בִּמְרוֹמָיו, הוּא יַעֲשֶׂה שָׁלוֹם עָלֵֽינוּ וְעַל כָּל־יִשְׂרָאֵל, וְאִמְרוּ אָמֵן:'));
          parts.push(p('יְראוּ אֶת־יְהֹוָה קְדוֹשָׁיו, כִּי אֵין מַחְסוֹר לִירֵאָיו: כְּפִירִים רָשׁוּ וְרָעֵֽבוּ, וְדוֹרְ֒שֵׁי יְהֹוָה לֺא־יַחְסְ֒רוּ כָל־טוֹב: הוֹדוּ לַיהֹוָה כִּי טוֹב, כִּי לְעוֹלָם חַסְדּוֹ: פּוֹתֵֽחַ אֶת־יָדֶֽךָ, וּמַשְׂבִּֽיעַ לְכָל־חַי רָצוֹן: בָּרוּךְ הַגֶּֽבֶר אֲשֶׁר יִבְטַח בַּיהֹוָה, וְהָיָה יְהֹוָה מִבְטַחוֹ: נַֽעַר הָיִֽיתִי גַם־זָקַֽנְתִּי וְלֺא־רָאִֽיתִי צַדִּיק נֶעֱזָב, וְזַרְעוֹ מְבַקֶּשׁ לָֽחֶם: יְהֹוָה עוֹז לְעַמּוֹ יִתֵּן, יְהֹוָה יְבָרֵךְ אֶת־עַמּוֹ בַּשָּׁלוֹם:'));

          // דיני שכחה (supplement)
          parts.push(sup(
            p('[דִּינֵי שְׁכֵחָה — אִם שָׁכַח לוֹמַר רְצֵה בְּשַׁבָּת אוֹ יַעֲלֶה וְיָבֹא בְּרֹאשׁ חֹדֶשׁ / יוֹם טוֹב:]') +
            p('בְּשַׁבָּת: בָּרוּךְ אַתָּה יְהֹוָה אֱלֹהֵֽינוּ מֶֽלֶךְ הָעוֹלָם אֲשֶׁר נָתַן שַׁבָּתוֹת לִמְנוּחָה לְעַמּוֹ יִשְׂרָאֵל בְּאַהֲבָה לְאוֹת וְלִבְרִית: בָּרוּךְ אַתָּה יְהֹוָה מְקַדֵּשׁ הַשַּׁבָּת:') +
            p('בְּרֹאשׁ חֹדֶשׁ: בָּרוּךְ אַתָּה יְהֹוָה אֱלֹהֵֽינוּ מֶֽלֶךְ הָעוֹלָם אֲשֶׁר נָתַן רָאשֵׁי חֳדָשִׁים לְעַמּוֹ יִשְׂרָאֵל לְזִכָּרוֹן:') +
            p('בְּיוֹם טוֹב: בָּרוּךְ אַתָּה יְהֹוָה אֱלֹהֵֽינוּ מֶֽלֶךְ הָעוֹלָם אֲשֶׁר נָתַן יָמִים טוֹבִים לְעַמּוֹ יִשְׂרָאֵל לְשָׂשׂוֹן וּלְשִׂמְחָה אֶת יוֹם חַג פלוני הַזֶּה: בָּרוּךְ אַתָּה יְהֹוָה מְקַדֵּשׁ יִשְׂרָאֵל וְהַזְּ֒מַנִּים:')
          ));
        }
