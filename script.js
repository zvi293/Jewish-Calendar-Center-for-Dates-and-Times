...
function appendSfaradTallitTefillinSections(parts, context) {
  var ashkenazHtml = buildShacharitAshkenazPayload(context).html;
  var start = ashkenazHtml.indexOf("<p><big><b>הַלְבָּשַׁת טַלִּית</b></big></p>");
  var end = ashkenazHtml.indexOf("<p><big><b>מַה טֹּבוּ</b></big></p>", start);
  if (start !== -1 && end !== -1 && end > start) {
    parts.push(ashkenazHtml.slice(start, end));
  }
}
...
function buildShacharitSfaradPayload(context) {
  ...
  appendSfaradTallitTefillinSections(parts, context2);
