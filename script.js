...
function buildShacharitAshkenazPayload(context) {
  ...
  parts.push(
    sup(
      '<small>בשעה שמניח אותו על ראשו להתעטף בו, יאמר:</small>',
    ),
  );
  parts.push(
    p(
  ...
  parts.push(
    sup(
      "<small>יניח התפילין של יד על קיבורת ידו, וקודם שיהדק יברך:</small>",
    ),
  );
  parts.push(
    p(
  ...
  parts.push(
    sup(
      "<small>ואחר שיהדק הרצועה על ראשו יאמר:</small>",
    ),
  );
  parts.push(
    p(
  ...
  parts.push(
    sup(
      "<small>ואח״כ כורך הרצועה של יד על אצבעו, ואומר:</small>",
    ),
  );
  parts.push(
    p(
  ...
  if (!context.isShabbat && !context.isYomTov) {
    parts.push(
      sup(
        "<small>יש שאין אומרים 'יהי רצון' בשבת ויום טוב</small>",
      ),
    );
    parts.push(
      p(
  ...
  parts.push(
    sup('<small>בחזרת הש"ץ אומרים כאן קדושה:</small>'),
  );
  ...
  if (isHallelDay) {
    ...
    hl.push(p("<small>הלל שלם: מברכים ואומרים הכל. חצי הלל: מברכים ומדלגים לֹא לָנוּ וְאָהַבְתִּי. בראש חודש ובשביעי שמיני של פסח אין מברכים לפני הלל למנהג אשכנז.</small>"));
    if (isFullHallel) {
      hl.push(p("<b>בָּרוּךְ</b> אַתָּה יְהֹוָה אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם אֲשֶׁר קִדְּשָׁנוּ בְּמִצְוֹתָיו וְצִוָּנוּ לִגְמֹר אֶת הַהַלֵּל:"));
    }
    hl.push(p("<b>הַלְלוּיָהּ</b> הַלְלוּ עַבְדֵי יְהֹוָה הַלְלוּ אֶת שֵׁם יְהֹוָה: יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד עוֹלָם: מִמִּזְרַח שֶׁמֶשׁ עַד מְבוֹאוֹ מְהֻלָּל שֵׁם יְהֹוָה: רָם עַל כָּל גּוֹיִם יְהֹוָה עַל הַשָּׁמַיִם כְּבוֹדוֹ: מִי כַּיְהֹוָה אֱלֹהֵינוּ הַמַּגְבִּיהִי לָשָׁבֶת: הַמַּשְׁפִּילִי לִרְאוֹת בַּשָּׁמַיִם וּבָאָרֶץ: מְקִימִי מֵעָפָר דָּל מֵאַשְׁפֹּת יָרִים אֶבְיוֹן: לְהוֹשִׁיבִי עִם נְדִיבִים עִם נְדִיבֵי עַמּוֹ: מוֹשִׁיבִי עֲקֶרֶת הַבַּיִת אֵם הַבָּנִים שְׂמֵחָה הַלְלוּיָהּ:"));
    hl.push(p("<b>בְּצֵאת</b> יִשְׂרָאֵל מִמִּצְרָיִם בֵּית יַעֲקֹב מֵעַם לֹעֵז: הָיְתָה יְהוּדָה לְקָדְשׁוֹ יִשְׂרָאֵל מַמְשְׁלוֹתָיו: הַיָּם רָאָה וַיָּנֹס הַיַּרְדֵּן יִסֹּב לְאָחוֹר: הֶהָרִים רָקְדוּ כְאֵילִים גְּבָעוֹת כִּבְנֵי צֹאן: מַה לְּךָ הַיָּם כִּי תָנוּס הַיַּרְדֵּן תִּסֹּב לְאָחוֹר: הֶהָרִים תִּרְקְדוּ כְאֵילִים גְּבָעוֹת כִּבְנֵי צֹאן: מִלִּפְנֵי אָדוֹן חוּלִי אָרֶץ מִלִּפְנֵי אֱלוֹהַּ יַעֲקֹב: הַהֹפְכִי הַצּוּר אֲגַם מָיִם חַלָּמִישׁ לְמַעְיְנוֹ מָיִם:"));
    if (!isFullHallel) {
      hl.push(p("<small>בחצי הלל מדלגים מכאן עד יְהֹוָה זְכָרָנוּ יְבָרֵךְ</small>"));
    } else {
      hl.push(p("<b>לֹא לָנוּ</b> יְהֹוָה לֹא לָנוּ כִּי לְשִׁמְךָ תֵּן כָּבוֹד עַל חַסְדְּךָ עַל אֲמִתֶּךָ: לָמָּה יֹאמְרוּ הַגּוֹיִם אַיֵּה נָא אֱלֹהֵיהֶם: וֵאלֹהֵינוּ בַשָּׁמָיִם כֹּל אֲשֶׁר חָפֵץ עָשָׂה: עֲצַבֵּיהֶם כֶּסֶף וְזָהָב מַעֲשֵׂה יְדֵי אָדָם: פֶּה לָהֶם וְלֹא יְדַבֵּרוּ עֵינַיִם לָהֶם וְלֹא יִרְאוּ: אָזְנַיִם לָהֶם וְלֹא יִשְׁמָעוּ אַף לָהֶם וְלֹא יְרִיחוּן: יְדֵיהֶם וְלֹא יְמִישׁוּן רַגְלֵיהֶם וְלֹא יְהַלֵּכוּ לֹא יֶהְגּוּ בִּגְרוֹנָם: כְּמוֹהֶם יִהְיוּ עֹשֵׂיהֶם כֹּל אֲשֶׁר בֹּטֵחַ בָּהֶם: יִשְׂרָאֵל בְּטַח בַּיְהֹוָה עֶזְרָם וּמָגִנָּם הוּא: בֵּית אַהֲרֹן בִּטְחוּ בַיְהֹוָה עֶזְרָם וּמָגִנָּם הוּא: יִרְאֵי יְהֹוָה בִּטְחוּ בַיְהֹוָה עֶזְרָם וּמָגִנָּם הוּא:"));
    }
    hl.push(p("<b>יְהֹוָה זְכָרָנוּ יְבָרֵךְ</b> יְבָרֵךְ אֶת בֵּית יִשְׂרָאֵל יְבָרֵךְ אֶת בֵּית אַהֲרֹן: יְבָרֵךְ יִרְאֵי יְהֹוָה הַקְּטַנִּים עִם הַגְּדֹלִים: יֹסֵף יְהֹוָה עֲלֵיכֶם עֲלֵיכֶם וְעַל בְּנֵיכֶם: בְּרוּכִים אַתֶּם לַיְהֹוָה עֹשֵׂה שָׁמַיִם וָאָרֶץ: הַשָּׁמַיִם שָׁמַיִם לַיְהֹוָה וְהָאָרֶץ נָתַן לִבְנֵי אָדָם: לֹא הַמֵּתִים יְהַלְלוּ יָהּ וְלֹא כָּל יֹרְדֵי דוּמָה: וַאֲנַחְנוּ נְבָרֵךְ יָהּ מֵעַתָּה וְעַד עוֹלָם הַלְלוּיָהּ:"));
    if (isFullHallel) {
      hl.push(p("<b>אָהַבְתִּי</b> כִּי יִשְׁמַע יְהֹוָה אֶת קוֹלִי תַּחֲנוּנָי: כִּי הִטָּה אָזְנוֹ לִי וּבְיָמַי אֶקְרָא: אֲפָפוּנִי חֶבְלֵי מָוֶת וּמְצָרֵי שְׁאוֹל מְצָאוּנִי צָרָה וְיָגוֹן אֶמְצָא: וּבְשֵׁם יְהֹוָה אֶקְרָא אָנָּה יְהֹוָה מַלְּטָה נַפְשִׁי: חַנּוּן יְהֹוָה וְצַדִּיק וֵאלֹהֵינוּ מְרַחֵם: שֹׁמֵר פְּתָאִים יְהֹוָה דַּלֹּתִי וְלִי יְהוֹשִׁיעַ: שׁוּבִי נַפְשִׁי לִמְנוּחָיְכִי כִּי יְהֹוָה גָּמַל עָלָיְכִי: כִּי חִלַּצְתָּ נַפְשִׁי מִמָּוֶת אֶת עֵינִי מִן דִּמְעָה אֶת רַגְלִי מִדֶּחִי: אֶתְהַלֵּךְ לִפְנֵי יְהֹוָה בְּאַרְצוֹת הַחַיִּים: הֶאֱמַנְתִּי כִּי אֲדַבֵּר אֲנִי עָנִיתִי מְאֹד: אֲנִי אָמַרְתִּי בְחָפְזִי כָּל הָאָדָם כֹּזֵב:"));
    }
    hl.push(p("<b>מָה אָשִׁיב לַיְהֹוָה</b> כָּל תַּגְמוּלוֹהִי עָלָי: כּוֹס יְשׁוּעוֹת אֶשָּׂא וּבְשֵׁם יְהֹוָה אֶקְרָא: נְדָרַי לַיְהֹוָה אֲשַׁלֵּם נֶגְדָה נָּא לְכָל עַמּוֹ: יָקָר בְּעֵינֵי יְהֹוָה הַמָּוְתָה לַחֲסִידָיו: אָנָּה יְהֹוָה כִּי אֲנִי עַבְדֶּךָ אֲנִי עַבְדְּךָ בֶּן אֲמָתֶךָ פִּתַּחְתָּ לְמוֹסֵרָי: לְךָ אֶזְבַּח זֶבַח תּוֹדָה וּבְשֵׁם יְהֹוָה אֶקְרָא: נְדָרַי לַיְהֹוָה אֲשַׁלֵּם נֶגְדָה נָּא לְכָל עַמּוֹ: בְּחַצְרוֹת בֵּית יְהֹוָה בְּתוֹכֵכִי יְרוּשָׁלָיִם הַלְלוּיָהּ:"));
    hl.push(p("<b>הַלְלוּ אֶת יְהֹוָה כָּל גּוֹיִם</b> שַׁבְּחוּהוּ כָּל הָאֻמִּים: כִּי גָבַר עָלֵינוּ חַסְדּוֹ וֶאֱמֶת יְהֹוָה לְעוֹלָם הַלְלוּיָהּ:"));
...
function buildShacharitSfaradPayload(context) {
  ...
  if (isHallelDay) {
    var hl = [];
    hl.push(p("<big><b>הַלֵּל</b></big>"));
    hl.push(p("<small>מברכים לפני הלל בכל יום. חצי הלל: מדלגים לֹא לָנוּ וְאָהַבְתִּי. הלל שלם: אומרים הכל.</small>"));
    hl.push(p("<b>בָּרוּךְ</b> אַתָּה יְהֹוָה אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם אֲשֶׁר קִדְּשָׁנוּ בְּמִצְוֹתָיו וְצִוָּנוּ לִגְמוֹר אֶת הַהַלֵּל:"));
    hl.push(p("<b>הַלְלוּיָהּ</b> הַלְלוּ עַבְדֵי יְהֹוָה הַלְלוּ אֶת שֵׁם יְהֹוָה: יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד עוֹלָם: מִמִּזְרַח שֶׁמֶשׁ עַד מְבוֹאוֹ מְהֻלָּל שֵׁם יְהֹוָה: רָם עַל כָּל גּוֹיִם יְהֹוָה עַל הַשָּׁמַיִם כְּבוֹדוֹ: מִי כַּיְהֹוָה אֱלֹהֵינוּ הַמַּגְבִּיהִי לָשָׁבֶת: הַמַּשְׁפִּילִי לִרְאוֹת בַּשָּׁמַיִם וּבָאָרֶץ: מְקִימִי מֵעָפָר דָּל מֵאַשְׁפֹּת יָרִים אֶבְיוֹן: לְהוֹשִׁיבִי עִם נְדִיבִים עִם נְדִיבֵי עַמּוֹ: מוֹשִׁיבִי עֲקֶרֶת הַבַּיִת אֵם הַבָּנִים שְׂמֵחָה הַלְלוּיָהּ:"));
    hl.push(p("<b>בְּצֵאת</b> יִשְׂרָאֵל מִמִּצְרָיִם בֵּית יַעֲקֹב מֵעַם לֹעֵז: הָיְתָה יְהוּדָה לְקָדְשׁוֹ יִשְׂרָאֵל מַמְשְׁלוֹתָיו: הַיָּם רָאָה וַיָּנֹס הַיַּרְדֵּן יִסֹּב לְאָחוֹר: הֶהָרִים רָקְדוּ כְאֵילִים גְּבָעוֹת כִּבְנֵי צֹאן: מַה לְּךָ הַיָּם כִּי תָנוּס הַיַּרְדֵּן תִּסֹּב לְאָחוֹר: הֶהָרִים תִּרְקְדוּ כְאֵילִים גְּבָעוֹת כִּבְנֵי צֹאן: מִלִּפְנֵי אָדוֹן חוּלִי אָרֶץ מִלִּפְנֵי אֱלוֹהַּ יַעֲקֹב: הַהֹפְכִי הַצּוּר אֲגַם מָיִם חַלָּמִישׁ לְמַעְיְנוֹ מָיִם:"));
    if (!isFullHallel) {
      hl.push(p("<small>בחצי הלל מדלגים מכאן עד יְהֹוָה זְכָרָנוּ יְבָרֵךְ</small>"));
    ...
    hl.push(p("<b>אָנָּא יְהֹוָה הַצְלִיחָה נָּא</b>: אָנָּא יְהֹוָה הַצְלִיחָה נָּא:"));
    hl.push(p("<b>בָּרוּךְ הַבָּא</b> בְּשֵׁם יְהֹוָה בֵּרַכְנוּכֶם מִבֵּית יְהֹוָה: <small>בָּרוּךְ הַבָּא בְּשֵׁם יְהֹוָה בֵּרַכְנוּכֶם מִבֵּית יְהֹוָה:</small> אֵל יְהֹוָה וַיָּאֶר לָנוּ אִסְרוּ חַג בַּעֲבֹתִים עַד קַרְנוֹת הַמִּזְבֵּחַ: <small>אֵל יְהֹוָה וַיָּאֶר לָנוּ אִסְרוּ חַג בַּעֲבֹתִים עַד קַרְנוֹת הַמִּזְבֵּחַ:</small> אֵלִי אַתָּה וְאוֹדֶךָּ אֱלֹהַי אֲרוֹמְמֶךָּ: <small>אֵלִי אַתָּה וְאוֹדֶךָּ אֱלֹהַי אֲרוֹמְמֶךָּ:</small> הוֹדוּ לַיְהֹוָה כִּי טוֹב כִּי לְעוֹלָם חַסְדּוֹ: <small>הוֹדוּ לַיְהֹוָה כִּי טוֹב כִּי לְעוֹלָם חַסְדּוֹ:</small>"));
    hl.push(p("<small><b>יְהַלְלוּךָ</b> יְהֹוָה אֱלֹהֵינוּ כָּל מַעֲשֶׂיךָ וַחֲסִידֶיךָ וְצַדִּיקִים עוֹשֵׂי רְצוֹנֶךָ וְכָל עַמְּךָ בֵּית יִשְׂרָאֵל בְּרִנָּה יוֹדוּ וִיבָרְכוּ וִישַׁבְּחוּ וִיפָאֲרוּ וִירוֹמְמוּ וְיַעֲרִיצוּ וְיַקְדִּישׁוּ וְיַמְלִיכוּ אֶת שִׁמְךָ מַלְכֵּנוּ כִּי לְךָ טוֹב לְהוֹדוֹת וּלְשִׁמְךָ נָאֶה לְזַמֵּר כִּי מֵעוֹלָם וְעַד עוֹלָם אַתָּה אֵל: בָּרוּךְ אַתָּה יְהֹוָה מֶלֶךְ מְהֻלָּל בַּתִּשְׁבָּחוֹת:</small>"));
